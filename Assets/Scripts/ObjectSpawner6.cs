...
public class ObjectSpawner6 : MonoBehaviour
{
    ...
    private int currentGroupInstantiatedFigures;
    private List<int> currentGroupTemp;
    private bool hasToCompleteGroup = false;
    #endregion
    ...
    private List<int> FindSmallerGroup()
    {
    ...
    private void CreateBox()
    {
        ...
        {
            currentGroupTemp = FindSmallerGroup();
    ...
    private void SetCurrentGroup(List<int> newGroup)
    {
    ...
    private List<List<Figure>> intantiatedObjects = new List<List<Figure>>();
